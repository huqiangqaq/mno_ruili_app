...
public class WorkDescribeActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.work_describe_activity);		
		...
		TextWatcher tw=new TextWatcher() {
			...
			public void afterTextChanged(Editable s) {
	            ...
	            if (temp.length() > 2000) {
	                Toast.makeText(WorkDescribeActivity.this,
		...
		tv_submit.setOnClickListener(new OnClickListener() {		
			...
			public void onClick(View v) {
				...
				intent.putExtra("workDescribe", et_workDescribe.getText().toString());
				WorkDescribeActivity.this.setResult(RESULT_OK, intent);
				WorkDescribeActivity.this.finish();				
			}
		});
	}
	@Override
	protected void onResume() {
		// TODO Auto-generated method stub
		super.onResume();
		MobclickAgent.onPageStart("WorkDescribeActivity");
	...
	protected void onPause() {
		// TODO Auto-generated method stub
		super.onPause();
		MobclickAgent.onPageEnd("WorkDescribeActivity");
