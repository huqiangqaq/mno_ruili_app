...
public class ChatRowMyEntity {
	private String jobName;//工作职位名称	
	private String workTime;	//工作经验
	private String education;//学历
	private String salary;	//薪水
	private String workPlace;//期望城市
	//private static String[] workerMsg;//亮点名字
	
	
	
	public ChatRowMyEntity() {
		super();
	}
	public ChatRowMyEntity(String jobName, String workTime, String education,
...
//	}	
	...
	public static ChatRowMyEntity getEntityFromJSONObject(JSONObject jsonMsgType){
		try {
...
//			JSONArray workerMsgs = jsonOrder.getJSONArray("workerMsg");
//			for(int i=0;i<workerMsgs.length();i++){
//				String msgs=workerMsgs.optString(i);
//				workerMsg[i] = msgs;
//			}			
			ChatRowMyEntity entity = new ChatRowMyEntity(jobName, workTime, education, salary, workPlace);
			//ChatRowMyEntity entity = new ChatRowMyEntity(jobName, workTime, education, salary, workPlace,workerMsg);
			return entity;
		} catch (JSONException e) {
			e.printStackTrace();
		}
