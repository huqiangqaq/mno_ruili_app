...
public class home_video extends AbActivity implements  com.gensee.net.RtComp.Callback,MediaPlayer.OnCompletionListener,
...
OnClickListener,OnVodListener,OnDocViewEventListener,OnVodPlayListener,OnSeekBarChangeListener {
	...
	//handler_和handler_3是课程详情,handler_2和handler_4是addlike,handler_5用户删除数据
   ...
   String liveManuUrl = "" ,isend="",isMem;
   String begintime = "";
   ...
   //View view;
	...
	private void digshow(String text) {
		...
		leftBtn1.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				Intent intent = null;
				intent = new Intent(home_video.this,DownloadActivity.class);
				intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP); 
				intent.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP); 
				startActivity(intent);		
				//unregisterReceiver(myReceiver);
				AbDialogUtil.removeDialog(home_video.this);
			}
	...
	private void initlist() {
		// TODO Auto-generated method stub
		 ...
		 pic=home_video.this. getResources().getDrawable( R.drawable.view_zan); 
		 pic2=home_video.this. getResources().getDrawable( R.drawable.view_nozan); 
		 picsc=home_video.this. getResources().getDrawable( R.drawable.zb_sc_true); 
		 picsc2=home_video.this. getResources().getDrawable( R.drawable.zb_sc_false); 
		 ...
		 mListView.setOnItemClickListener(new OnItemClickListener(){
				...
				public void onItemClick(AdapterView<?> parent, View view,
					...
					intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP); 
					//intent.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP); 
					home_video.this.startActivity(intent);
					finish();
	...
	public void onclick(View view) {
		 ...
		 if(view.getId()==R.id.select_sj)
    	{
			 ...
			 select_sj_text.setTextColor(android.graphics.Color.parseColor("#ff6200"));//老版颜色#387ebc
    		...
    		else
    		{
    			if(isCollect.equals("0"))
   			 {
				  ...
				  if(label.equals("3")){
					  if(!liveManuUrl.equals("null")){
						...
						view_sc.setImageDrawable(home_video.this. getResources().getDrawable( R.drawable.zb_tx));					
				  }else
					view_sc.setImageDrawable(picsc);
   			 	}
   			  ...
   			  if(label.equals("3"))
			  {
				  if(!liveManuUrl.equals("null"))
				  {
					...
					view_sc.setImageDrawable(home_video.this. getResources().getDrawable( R.drawable.zb_tx2));
    	...
    	else if(view.getId()==R.id.view_back)
    	{
    	...
    	else if(view.getId()==R.id.nei_pl)
			{
				if(!appuser.getInstance().IsLogin())
		   	 {
					 appuser.getInstance().LoginToAct(home_video.this,  home_video.class);
		   		 return;
		   	 }
				 pl_box.setVisibility(View.GONE);;
	...
	private void init() {
		...
		videoView.setOnClickListener(home_video.this);
	        ...
	        error.setOnClickListener(home_video.this);
	        // 暂停和播放
	        playButton.setOnClickListener(home_video.this);
	        surfaceView.setOnClickListener(home_video.this);
	        videoSizeButton.setOnClickListener(home_video.this);
	        videoSizeButton2.setOnClickListener(home_video.this);
	        dbonclick.setOnClickListener(home_video.this);
	        zbonclick.setOnClickListener(home_video.this);
	...
	private void InitHandler()
	{
		handler_5 = new webhandler(){
			...
			public void OnError(int code, String mess) {
				...
				String ms=mess;
				ms=ms+"";
				MessageBox.Show(home_video.this,mess);
			}
			@Override
			public void OnResponse(JSONObject response) {
				if(label.equals("3")){					
					if(!liveManuUrl.equals("null"))
					  {
						Toast.makeText(home_video.this, "已取消收藏", Toast.LENGTH_SHORT).show();		
					  }
					else
						Toast.makeText(home_video.this, "已取消预约", Toast.LENGTH_SHORT).show();					
				}
				else
					Toast.makeText(home_video.this, "已取消收藏", Toast.LENGTH_SHORT).show();
			...
			try {				
				...
				if(mess.equals("null") == false && mess.length() > 1)
				{
					if(label.equals("3"))
					{
						if(!liveManuUrl.equals("null"))
						  {
							Toast.makeText(home_video.this, "收藏成功", Toast.LENGTH_SHORT).show();			
						  }
						else
						Toast.makeText(home_video.this, "已预约成功", Toast.LENGTH_SHORT).show();  						
					}
					else
					Toast.makeText(home_video.this, "收藏成功", Toast.LENGTH_SHORT).show();
				}								
			...
			@Override
  			public void OnResponse(JSONObject response) {
				...
				try {					
					...
					if(mess.equals("null") == false && mess.length() > 1)
					{
						Toast.makeText(home_video.this, mess, Toast.LENGTH_SHORT).show();
					}					
				} catch (JSONException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
		...
		handler_ = new webhandler(){
			...
			public void OnResponse(JSONObject response) {				
				try {
				    ...
				    isMem=jsonObject.getString("isMembers");
				    //直播视频
				    if(label.equals("3")){				    	
					...
					HorizontalListView tag=((HorizontalListView) home_video.this.findViewById(R.id.wd_tag) );					
			          ...
			          saImageItems = new mySimpleAdapter(home_video.this, //没什么解释  
			          ...
			          tag.setOnItemClickListener(new OnItemClickListener(){
							...
							public void onItemClick(AdapterView<?> parent, View view,
								...
								if(mchoseList.get(position).getName().toString().trim().length()<=0)
									return;
								MessageBox.Show(home_video.this, mchoseList.get(position).getName());
								Intent intent0 = new Intent(home_video.this, nei_find.class); 
				        		...
				        		home_video.this.startActivity(intent0);				     
							}
						});
					    list = new ArrayList<DownloadDetail>();
				        list.clear();
				        list.add(new DownloadDetail(Integer.parseInt(id), url,imageurl,
			...
			rootView.smoothScrollTo(0, 0);
			handler_.SetProgressDialog(home_video.this);			
	}	
	private void digshow3() {
		// TODO Auto-generated method stub
		View mView = null;
    	mView = mInflater.inflate(R.layout.dialog_myconfig,null);
		AbDialogUtil.showDialog(mView,R.animator.fragment_top_enter,R.animator.fragment_top_exit,
				R.animator.fragment_pop_top_enter,R.animator.fragment_pop_top_exit);
		Button leftBtn1 = (Button)mView.findViewById(R.id.left_btn);
		Button rightBtn1 = (Button)mView.findViewById(R.id.right_btn);
		TextView title_choices = (TextView)mView.findViewById(R.id.title_choices);
		TextView choice_one_text= (TextView)mView.findViewById(R.id.choice_one_text);
		leftBtn1.setText("前往购买");
		rightBtn1.setText("算了，不看了");
		choice_one_text.setText("此为VIP会员课程，请开通VIP免费收看");
		leftBtn1.setOnClickListener(new OnClickListener(){
			@Override
			public void onClick(View v) {
				Intent intent0 = new Intent(home_video.this, my_buy.class); 			    
	...
	private void digshow2() {
		...
		public void remenber()
		{
			if(Constant.playPosition>0)
			{
                ...
                home_video.this.sendBroadcast(intent);  
			}
		}
		@Override
		protected void onPause() {
			// TODO Auto-generated method stub
			MobclickAgent.onPageEnd("home_video");
		  ...
		  @Override
		    protected void onResume() {
		       super.onResume();
		       MobclickAgent.onPageStart("home_video");
		...
		protected void onDestroy() {   //activity销毁后，释放资源
			...
			this.threadDisable = true;
				 try {
			            if (null != home_video.this.mediaPlayer) {
			                ...
			                // 释放mediaPlayer
			                home_video.this.mediaPlayer.release();
			                home_video.this.mediaPlayer = null;
			                Constant.playPosition = -1;
			            }
			        } catch (Exception e) {
...
/*分享*/
	...
	public void performShare(SHARE_MEDIA platform) {
	    ...
	    mController.postShare(home_video.this, platform, new SnsPostListener() {

	    	
	    	 @Override
	         public void onStart() {
	            MessageBox.Show(home_video.this , "开始分享");
	         }
	...
	private void addQQQZonePlatform() {
	    ...
	    UMQQSsoHandler qqSsoHandler = new UMQQSsoHandler(home_video.this,
	            appId, appKey);
	    ...
	    // 添加QZone平台
	    QZoneSsoHandler qZoneSsoHandler = new QZoneSsoHandler(home_video.this, appId, appKey);
	    qZoneSsoHandler.addToSocialSDK();
	    
		mController.setShareContent(Constant.SOCIAL_CONTENT);
		// 设置分享图片, 参数2为图片的url地址
		mController.setShareMedia(new UMImage(home_video.this,  Constant.SOCIAL_IMAGE));
	...
	private void addWXPlatform() {
	    ...
	    // 添加微信平台
	    UMWXHandler wxHandler = new UMWXHandler(home_video.this, appId, appSecret);
	    ...
	    // 支持微信朋友圈
	    UMWXHandler wxCircleHandler = new UMWXHandler(home_video.this, appId, appSecret);
	...
	// SurfaceView的callBack
	    ...
	    public void playVideo() {
	        ...
	        try {
	            ...
	            mediaPlayer.setDataSource(home_video.this, uri);
	    ...
	    final Handler handler = new Handler( ) {
	    	  ...
	    	  break;
	    	  case 2:
	    		  int i=NetworkUtils.getConnectivityStatus(home_video.this);
	        ...
	        public void run() {
	            ...
	            try {
	                while (seekBarAutoFlag) {
	                    ...
	                    if (null != home_video.this.mediaPlayer
	                            || home_video.this.mediaPlayer.isPlaying()) {
	    ...
	    public void onClick(View v) {
	        ...
	        if (v == playButton) {	        	
	        	...
	        	//1.label=1是普通视频
	        	if(!appuser.getInstance().IsLogin()){
		  			 appuser.getInstance().Login(home_video.this);
		  			 MessageBox.Show(home_video.this, "该功能需要登录以后才可以使用\n请登录");
		  			 return;
		    	}
	        	//2.label=3是直播视频
	        	if(label.equals("3")){
	        		if(isMem.equals("1")&&!Constant.indentify.equals("会员")){//当前直播的视频为会员才能观看的        			
						 digshow3();
			  			 return;			    	 
	        		}
					if(get(begintime)<0){
					...
					runOnUiThread(new Runnable() {
						public void run() {
							...
							case JoinResult.JR_OK:
								AlertUtil.toast(home_video.this, "您已加入成功");
							...
							if(resultDesc != null){
								Toast.makeText(home_video.this,resultDesc,Toast.LENGTH_SHORT).show();
							}
						}
					});
		...
		public void onErr(final int errCode) {
			...
			runOnUiThread(new Runnable() {
				...
				public void run() {
					...
					Toast.makeText(home_video.this,"初始化错误:错误码" + errCode
		...
		public void onVodErr(final int errCode) {
			...
			runOnUiThread(new Runnable() {
				...
				public void run() {
					...
					if (!"".equals(msg)) {
						Toast.makeText(home_video.this , msg, Toast.LENGTH_SHORT)
								.show();
					}
				}
			});
