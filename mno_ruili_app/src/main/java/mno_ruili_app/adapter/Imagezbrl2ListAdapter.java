 ...
 * @version
 */
public class Imagezbrl2ListAdapter extends BaseAdapter{
    ...
    * @param to view的id
    */
    public Imagezbrl2ListAdapter(Context context, ArrayList<zb_tv> mTvList ){
    ...
    //LinearLayout zb_rq;
    TextView zbrl_title,zbrl_time,zbrl_zj,tv_vipp;
    ImageView zb_sc;
    ...
    public View getView(int position, View convertView, ViewGroup parent){
          if(convertView == null){
	           ...
	           convertView = mInflater.inflate(R.layout.item_list_zbrl2, parent, false);
          }                   
          zb_sc= AbViewHolder.get(convertView, R.id.zb_sc);
          zbrl_title= AbViewHolder.get(convertView, R.id.zbrl_title);
          zbrl_time= AbViewHolder.get(convertView, R.id.zbrl_time);
          zbrl_zj= AbViewHolder.get(convertView, R.id.zbrl_zj);  
          ...
          if(isMem.equals("1")){
				//tv_vipp.setBackgroundResource(R.drawable.vip_pre);
        	  tv_vipp.setVisibility(View.VISIBLE);
		   }else{
			   tv_vipp.setVisibility(View.INVISIBLE);
		  }
          if(!mtv.getisCollect().equals(""))          
          {
          ...
          zbrl_title.setText(zb_title_);
          if(zb_time_.length()>0)
          {
          zbrl_time.setText(zb_time_.substring(11, 16));
          }
          else
        	  zbrl_time.setText("");
          zbrl_zj.setText(zb_zj_);  
          return convertView;
    }
