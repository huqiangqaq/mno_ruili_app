...
public class AddEduExpAdapter extends  BaseAdapter{
    ...
    * @param to view的id
    */
    public AddEduExpAdapter(Context context, List<Worker> data,
    ...
    public View getView(final int position, View convertView, ViewGroup parent){
          ...
          TextView tv_edit = AbViewHolder.get(convertView, mTo[6]);
          TextView tv_delete = AbViewHolder.get(convertView, mTo[7]);
		  //获取该行的数据        
          final Worker eduExp= (Worker)mData.get(position);
  		  ...
  		  final String eduLevel=eduExp.getJobName();
  		  tv_eduLevel.setText(eduLevel);
  		  
          final String joinSchool=eduExp.getWorkTime();      
          tv_joinSchool.setText( joinSchool);
          
          final String leaveSchool=eduExp.getEducation();     
          tv_leaveSchool.setText(leaveSchool);
          
          final String major=eduExp.getSalary();     
          tv_major.setText(major);
          
          final String schoolDescribe=eduExp.getWorkPlace();         
          tv_schoolDescribe.setText(schoolDescribe);
          
          final String stu_exp_id=eduExp.getNickName();
          
          tv_edit.setOnClickListener(new OnClickListener() {
  			
  			@Override
  			public void onClick(View arg0) {
  				Intent in=new Intent(mContext,AddEduExp.class);
  				in.putExtra("from", "d");
  				in.putExtra("school", school);
  				in.putExtra("eduLevel",eduLevel);
  				in.putExtra("joinSchool", joinSchool);
  				in.putExtra("leaveSchool", leaveSchool);
  				in.putExtra("major", major);
  				in.putExtra("schoolDescribe", schoolDescribe);
            ...
            tv_delete.setOnClickListener(new OnClickListener() {
    			...
    			public void onClick(View arg0) {
    				...
    				builder.setMessage("确定要删除当前选择的学习经历吗？");
    				builder.setTitle("提示");
    				builder.setPositiveButton("确定",new DialogInterface.OnClickListener() {
    					...
    					public void onClick(DialogInterface dialog,int which) {
    	    				...
    	    				params1.put("stu_exp_id", stu_exp_id);
    	    				handler1.SetRequest(new RequestType("ZP",Type.deleteStuExp),params1);
