...
public class EaseMessageAdapter extends BaseAdapter{
	...
	private static final int MESSAGE_TYPE_SENT_POST = 16;
	private static final int MESSAGE_TYPE_RECV_POST = 17;
...
//		    else if(message.getBooleanAttribute("msgRe", false)){
//		    	return message.direct() == EMMessage.Direct.RECEIVE ? MESSAGE_TYPE_RECV_RESUME : MESSAGE_TYPE_SENT_RESUME;
//		    }else if(message.getBooleanAttribute("msgPost", false)){
...
//            else if(message.getBooleanAttribute("msgRe", false)){
//            	chatRow = new EaseChatRowResume(context, message, position, this);
//            }
//            else if(message.getBooleanAttribute("msgPost", false)){
//            	chatRow = new EaseChatRowPost(context, message, position, this);
//            }
            else{
