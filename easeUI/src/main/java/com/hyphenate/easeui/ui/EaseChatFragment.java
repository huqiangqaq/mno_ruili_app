...
//		EaseChatFragment.this.getActivity().sendBroadcast(intent);
        IntentFilter filter3= new IntentFilter();
		filter3.addAction("huihua");
		EaseChatFragment.this.getActivity().registerReceiver(myPushReceiver, filter3);
...
//    }
    ...
    public void onDestroy() {
        ...
        EaseChatFragment.this.getActivity().unregisterReceiver(myPushReceiver);
    }
